  ...
  return (
    <>
        ...
        <div className='container'>
                <h1 className='title' >
                    <img className='imgLogo' src="https://www.xtrafondos.com/wallpapers/rick-y-morty-portal-dimensional-6603.jpg" alt="" />
                        Rick And Morty
                </h1>
                <div className='container2'>
                    ...
                    data?.map(items => (
                        <Link to={`${items.id}`} key={items.id} className="card">
                                ...
                                <hr />
                                <br />
                                <h3 className='gender'>gender: <span>{items.gender}</span></h3>
                                <h3 className='status'>status: <span>{items.status}</span></h3>
                                <h3 className='location'>last known location: <span>{items.location.name}</span></h3>      
                        </Link>
                        ))
                    }
                </div>
